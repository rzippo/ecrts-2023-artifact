...
public class CurveUpperPseudoInverseOverInterval
{
    ...
    {
        foreach (var testCase in CurveUpperPseudoInverse.ContinuousTestCases())
            yield return new object[] { testCase[0] };

        foreach (var testCase in CurveUpperPseudoInverse.LeftContinuousTestCases())
            yield return new object[] { testCase[0] };

        foreach (var testCase in CurveUpperPseudoInverse.RightContinuousTestCases())
            yield return new object[] { testCase[0] };

        foreach (var testCase in CurveUpperPseudoInverse.CornerTestCases())
            yield return new object[] { testCase[0] };
