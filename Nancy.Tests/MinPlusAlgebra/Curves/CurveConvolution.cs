...
public class CurveConvolution
{
    ...
    {
        var lc = IsomorphismOptimization.ContinuousExamples
            .Concat(IsomorphismOptimization.LeftContinuousExamples);
        var rc = IsomorphismOptimization.RightContinuousExamples;
    ...
    public void LeftContinuityAtLeastOne(Curve f, Curve g)
    {
        ...
        var conv = Curve.Convolution(f, g);
